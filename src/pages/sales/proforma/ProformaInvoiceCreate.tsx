...
// Purity options (for jewelry items)
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                    ...
                    <span className="font-semibold text-red-500">-{formatCurrency(totals.discountTotal)}</span>
                  </div>
                  <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                    <span className="text-sm text-gray-600">Select GST</span>
                    <select 
                      value={selectedGST}
