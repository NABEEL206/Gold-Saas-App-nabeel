          ...
          <div className="flex items-center gap-3">
            ...
            >
              {isSubmitting ? (
                ...
                <><Save className="h-4 w-4" />Save Journal</>
              )}
            </button>
          </div>
        </div>
            ...
            >
              ...
              <div className="divide-y overflow-visible" style={{ borderColor: 'var(--border-subtle)' }}>
                {formData.entries.map((entry, index) => (
                  <div key={index} className="grid grid-cols-12 gap-3 px-4 py-2 items-center themed-transition hover:bg-surface" style={{ borderColor: 'var(--border-subtle)' }}>
