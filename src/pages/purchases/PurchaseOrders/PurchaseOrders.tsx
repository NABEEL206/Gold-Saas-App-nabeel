...
const PurchaseOrders: React.FC = () => {
  ...
  const handleBulkDeleteAction = async () => {
    ...
    if (window.confirm(`Delete ${selectedItems.length} purchase orders?`)) {
  ...
  if (refreshLoading) {
    return (
      <div className="p-6 flex items-center justify-center min-h-[400px]">
        <LoadingSpinner size="lg" text="Refreshing purchase orders..." />
      </div>
    );
  }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete purchase order "<span className="font-medium">{orderToDelete.poNumber}</span>"? 
